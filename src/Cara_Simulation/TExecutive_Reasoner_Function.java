...
//				Game.Press_Enter();
				...
				ArrayList<TActive_Desire> Desires = this.Agent.Get_GW().Get_Desires();
				...
				for(TActive_Desire Desire: Desires)
				{
					...
					if(Can_Analyze_Desire)
					{
						...
						if (Goal instanceof TFunctional_Desire) 
						{
							Game.Print("********* --------------- *************");
							Game.PrintLn();
						...
						else //if (Goal instanceof TEpistemic_Goal) 
						{
							...
							TEpistemic_Desire Epistemic_Goal = (TEpistemic_Desire) Goal;
...
//				Game.Press_Enter();
				...
				for(TActive_Desire Desire: Desires_To_Promote)
				{
					...
					{
						TFunctional_Desire Functional_Goal = (TFunctional_Desire) Desire.get_Attentional_Goal();
					...
					{
						TEpistemic_Desire Epistemic_Goal = (TEpistemic_Desire) Desire.get_Attentional_Goal();
...
//					if(Intention.get_Desire().get_Attentional_Goal() instanceof TFunctional_Goal)
					//this is used only to show the focusing of the agent in Scenario 2
						{
							if(Desire.get_Attentional_Goal().get_Name().equals("Visit_Rome"))
							{
//								if(! Fucused_Message)
								{
									...
									String Quality_goal_Name = Desire.get_Attentional_Goal().get_List_Quality_Goal().getFirst().get_Name();
...
//		{
			...
			for(TActive_Desire Desire: desires)
			{
				TAttentional_Desire Attentional_Goal = Desire.get_Attentional_Goal();
