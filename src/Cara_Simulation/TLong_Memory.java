...
public class TLong_Memory {
	...
	private ArrayList<TAttentional_Desire>  Attentional_Goals_Satisfied;
	...
	public TLong_Memory(TExecutive_Working_Memory_Maintenance wmm)
	{
		...
		this.Attentional_Goals_Satisfied = new ArrayList<TAttentional_Desire>();
...
//	}
	...
	public void AddAll_Attentional_Goals(ArrayList<TAttentional_Desire> attentional_Goals)
	{
		for(TAttentional_Desire Attentional_Goal: attentional_Goals)
		{
			this.Add_Attentional_Goal(Attentional_Goal);
		}
	}
	
	public void Add_Attentional_Goal(TAttentional_Desire attentional_Goal)
	{
		...
		else
		{
			...
			TEpistemic_Desire pistemic_Goal = (TEpistemic_Desire) attentional_Goal;
	...
	{
		Integer result = 0;
		for(TAttentional_Desire Goal: this.Goals)
		{
	...
	public void AddAll_Functional_Goals(ArrayList<TFunctional_Desire> functional_Goals)
	{
	...
	public void Add_Functional_Goal(TFunctional_Desire functional_Goal)
	{
	...
	public void AddAll_Epistemic_Goals(ArrayList<TEpistemic_Desire> epistemic_Goals)
	{
	...
	public void Add_Epistemic_Goal(TEpistemic_Desire epistemic_Goal)
	{
		//In this case, Functional and Epistemic Goals are stored in a list of Attentional Goals
		// called "Goals"
...
//		Environment3 Map = this.Get_Map()
	...
	public void Delete_Goal(TAttentional_Desire Goal)
	{
		this.Goals.remove(Goal);
	}
	
	public void Insert_Attentional_Goals_Satisfied(TAttentional_Desire Goal)
	{
