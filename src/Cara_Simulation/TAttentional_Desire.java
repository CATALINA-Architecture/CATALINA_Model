 ...
 */
public class TAttentional_Desire extends TGoal{
	 ...
	 */
	public TAttentional_Desire(String name, Double saliency, Double reward, Double relax_Preference, ArrayList<TGreen_Goal> list_Green_Goal,
	...
	public TAttentional_Desire(String name, ArrayList<String> list_Green_Goal_name, ArrayList<String> list_Quality_Goal_name, 
