...
public class TEpistemic_Desire extends TAttentional_Desire{
	...
	public TEpistemic_Desire(String name, TBelief belief, Double saliency, Double reward, Double relax_Preference,
	...
	public TEpistemic_Desire(String name, String belief_Name, Double saliency, Double reward, Double relax_Preference,
