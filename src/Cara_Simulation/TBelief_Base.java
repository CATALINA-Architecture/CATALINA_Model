...
public class TBelief_Base implements Serializable{
	...
	public TBelief_Base(String name, TPredicate predicate, Boolean truth, Object information_Source,
...
//										predicate.get_Object_Complement());
	...
	public TBelief_Base(String name, String predicate_Name, Boolean truth, Object information_Source,
			LocalDateTime time_stamp, TType_Beliefs type_Belief)
	{
		this.Name = name;
////		this.Predicate = new TPredicate(predicate.get_Subject(), predicate.get_Relationship(), 
