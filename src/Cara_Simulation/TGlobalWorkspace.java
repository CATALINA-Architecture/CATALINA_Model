...
public class TGlobalWorkspace {
	...
	//Goal Properties
	private ArrayList<TAttentional_Desire> Goals;
	private ArrayList<TAttentional_Desire> Inhibited_Goals;
	private ArrayList<TAttentional_Desire> UnInhibited_Goals;
	private HashMap<String, TAttentional_Desire> Map_Goals;
	
	//Goal Properties
	private ArrayList<TFunctional_Desire> Functional_Goals;
	private ArrayList<TEpistemic_Desire> Epistemic_Goals;
	private ArrayList<TFunctional_Desire> Inhibited_Functional_Goals;
	...
	private HashMap<TAttentional_Desire, ArrayList<TBelief>> Map_Attentional_Goal_and_Beliefs;
	private HashMap<TAttentional_Desire, ArrayList<Object>> Map_Attentional_Goal_and_Regions;
	...
	public TGlobalWorkspace(TAgent agent)
	{
		...
		this.Goals = new ArrayList<TAttentional_Desire>();
		
		//I create the list of all the Goals
		this.Inhibited_Goals = new ArrayList<TAttentional_Desire>();
		this.UnInhibited_Goals = new ArrayList<TAttentional_Desire>();
		
		this.Functional_Goals = new ArrayList<TFunctional_Desire>();
		this.Epistemic_Goals = new ArrayList<TEpistemic_Desire>();
		
		this.Inhibited_Functional_Goals = new ArrayList<TFunctional_Desire>();
		
		this.Functional_Goals_Names = new ArrayList<String>();
		this.Inhibited_Goals_Names = new ArrayList<String>();
		
		this.Map_Goals = new HashMap<String, TAttentional_Desire>();
		...
		this.Map_Attentional_Goal_and_Beliefs = new HashMap<TAttentional_Desire, ArrayList<TBelief>>();
...
//		Game.Print("Desire at the before: "+this.Desires.size());
		...
		for(int i=0;i<dim;i++)
		{
			Game.Gui_Map.Show_Message("Title", "I Delete the Desire Name: "+Desire_To_Remove.get(i).get_Attentional_Goal().get_Name(), null);
...
//		Game.End_Game();
	...
	//TODO to check
	public ArrayList<TAttentional_Desire> Get_Goals()
	{
	...
	public void Add_Goal(TAttentional_Desire Attentional_Goal)
	{
		if (!this.Goals.contains(Attentional_Goal))
		{
			this.Goals.add(Attentional_Goal);
		}
		if(Attentional_Goal instanceof TFunctional_Desire)
		{
			TFunctional_Desire Functional_Goal = (TFunctional_Desire) Attentional_Goal;
		...
		if(Attentional_Goal instanceof TEpistemic_Desire)
		{
			TEpistemic_Desire Epistemic_Goal = (TEpistemic_Desire) Attentional_Goal;
	...
	public ArrayList<TAttentional_Desire> Get_Uninhibited_Goals()
	{
	...
	//TODO to check
	public ArrayList<TFunctional_Desire> Get_Functional_Goals()
	{
		if (Goals.size()==0)
			this.Get_Goals();
...
//		this.get_func
	...
	public ArrayList<TEpistemic_Desire> Get_Epistemic_Goals()
	{
	...
	public ArrayList<TAttentional_Desire> Get_Inhibited_Goals()
	{

		return this.Inhibited_Goals;
	}
	
	public ArrayList<TFunctional_Desire> Get_Inhibited_Functional_Goals()
	{
...
//	}
	...
	public HashMap<TAttentional_Desire, ArrayList<TBelief>> Get_Map_Attentional_Goal_and_Beliefs2()
	{
...
//		}
	...
	// TODO DEVELOPMENT
		public void Update_Inhibited_Goals(ArrayList<TAttentional_Desire> Inhibited_Goals)
		{
...
//			for(TAttentional_Goal Attentional_Goal: this.Get_Goals())
			for(TAttentional_Desire Attentional_Goal: this.Get_Goals())
			{
...
//			this.Agent.Get_GW().Print_Data(0, 0);
			...
			{
				i++;
				if(Desire.get_Attentional_Goal() instanceof TFunctional_Desire)
				{
					TFunctional_Desire Goal = (TFunctional_Desire) Desire.get_Attentional_Goal();
				...
				{
					TEpistemic_Desire Goal = (TEpistemic_Desire) Desire.get_Attentional_Goal();
...
//	}
	...
	public HashMap<TAttentional_Desire, ArrayList<TBelief>> Get_List_Beliefs() 
	{
		return this.Map_Attentional_Goal_and_Beliefs;
	}
...
//			this.Agent.get_E_Switching_Function().AM_Exogenous_Module();
	...
	public TEpistemic_Desire Stimulus_to_Goal(TStimulus Salient_Belief)
	{
		...
		TEpistemic_Desire Epistemic_Goal = this.Agent.Get_WMM().Stimulus_to_Goal(Salient_Belief);
...
//				this.Get_Goals();
			...
			if (Synthesis==1)
			{
				...
				for(TAttentional_Desire Goal: this.UnInhibited_Goals)
				{
			...
			{
				Game.Print("Goal Names:");
				for(TAttentional_Desire Goal: this.Agent.Get_WMM().Get_Attentional_Goals())
				{
					Game.Print(Goal.get_Name());
				}
				Game.PrintLn();
			...
			if (Synthesis==1)
			{
				...
				for(TAttentional_Desire Goal: this.Agent.Get_WMM().Get_Inhibited_Functional_Goals())
				{
					Game.Print(Goal.get_Name());
				}
			}
		...
		if(this.Updated_Desires_for_print)
		{
			...
			int i=0;
			for(TActive_Desire Desire: this.Desires)
			{
				i++;
		...
		if(this.Updated_Intentions_for_print)
		{
			...
			{
				i++;
				TActive_Desire Desire = Intention.get_Desire();
		...
		if (this.Updated_Desires)
		{
			...
			if(Desires.size()>0)
			{
				for(Object who: Desires)
				{
					...
					{
						//Game.Print("I invoke this.Agent.Get_Reasoner().Updated_Desires()");
						this.Agent.Get_E_Inhibition_function().Updated_Desires();
					}
