...
//		for (int i = 0; i < Color_Route.Locomotives.size(); i++) 
	 ...
	 *         the path
	 */
	protected EnumMap<TType_Quality_Desire, Double> Compute_Sum_Weights(List<City> Path) {
		...
		Total_Weights.put(TType_Quality_Desire.TGQ_Locomotive, Locomotive_Route);
		Total_Weights.put(TType_Quality_Desire.TGQ_Panorama, Panorama_Route);
		Total_Weights.put(TType_Quality_Desire.TGQ_Velocity, Speed__Route);
	...
	protected EnumMap<TType_Quality_Desire, Double> Compute_Sum_Weights_Routes(List<Integer> Routes_Path) {
		...
		Weights.put(TType_Quality_Desire.TGQ_Locomotive, Locomotive_Route / Routes_Number);
		Weights.put(TType_Quality_Desire.TGQ_Panorama, Panorama_Route / Routes_Number);
		Weights.put(TType_Quality_Desire.TGQ_Velocity, Speed_Route / Routes_Number);
