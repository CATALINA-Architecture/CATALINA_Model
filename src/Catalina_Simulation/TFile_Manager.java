...
//		}
	...
	public ArrayList<TEpistemic_Standing_Desire> Read_Epistemic_Standing_Desires()
	{
		...
		try (FileInputStream fileIn = new FileInputStream(File_name);
			     ObjectInputStream in = new ObjectInputStream(fileIn)) {
			Epistemic_Goals = (ArrayList<TEpistemic_Standing_Desire>) in.readObject();
	...
	public ArrayList<TFunctional_Standing_Desire> Read_Functional_Standing_Desires()
	{
		...
		try (FileInputStream fileIn = new FileInputStream(File_name);
			     ObjectInputStream in = new ObjectInputStream(fileIn)) {
			Functional_Goals = (ArrayList<TFunctional_Standing_Desire>) in.readObject();
	...
	{ 
		...
		try (FileInputStream fileIn = new FileInputStream(File_name);
			     ObjectInputStream in = new ObjectInputStream(fileIn)) {
			Green_Goals = (ArrayList<TGreen_Standing_Desire>) in.readObject();
	...
	public ArrayList<TQuality_Standing_Desire> Read_Quality_Standing_Desires()
	{
		...
		try (FileInputStream fileIn = new FileInputStream(File_name);
			     ObjectInputStream in = new ObjectInputStream(fileIn)) {
			Quality_Goals = (ArrayList<TQuality_Standing_Desire>) in.readObject();
...
//		LocalDateTime ldt= LocalDateTime.now().withNano(0);
		...
		Predicates.add(new TPredicate( "p"+i, TType_Green_Desire.TGG_Locomotive,TType_Relationship.minor_equal, 
				0.8));
		...
		Predicates.add(new TPredicate( "p"+i, TType_Quality_Desire.TGQ_Panorama,TType_Relationship.is, 
				"great"));
		
		//Driving\_Safely (Velocity\_is\_Moderate)
		i++;
		Predicates.add(new TPredicate( "p"+i, TType_Quality_Desire.TGQ_Velocity,TType_Relationship.is, 
				"moderate"));
...
//		
		...
		this.Init_Creation_Path_Travelled_for_Functional_Desire = i;
		this.Write_Beliefs(Beliefs);
	}
	
	public void Create_Epistemic_Desires()
	{
		ArrayList<TEpistemic_Standing_Desire> Epistemic_Goals = new ArrayList<TEpistemic_Standing_Desire>();
		ArrayList<TEpistemic_Standing_Desire> Leggere_Beliefs = null;
...
//		Quality_Goals_List.add("qg1");
		...
		TEpistemic_Standing_Desire epi1 = new TEpistemic_Standing_Desire("g3", "b1", 1.0, 2.0, 3.0, Green_Goals_List, 
				Quality_Goals_List);
		TEpistemic_Standing_Desire epi2 = new TEpistemic_Standing_Desire("g4", "b2", 1.0, 2.0, 3.0, Green_Goals_List, 
				Quality_Goals_List);
	...
	public void Create_Functional_Desires()
	{
		ArrayList<TFunctional_Standing_Desire> Functional_Goals = new ArrayList<TFunctional_Standing_Desire>();
		ArrayList<TEpistemic_Standing_Desire> Leggere_Epistemic_Goals = null;
...
//		Functional_Goals.add(func2);
	...
	public void Create_Green_Desires()
	{
		ArrayList<TGreen_Standing_Desire> Green_Goals = new ArrayList<TGreen_Standing_Desire>();
		//Limited_Pollution_to_0.8
		Green_Goals.add(new TGreen_Standing_Desire("gg1", "p5", TType_Green_Desire.TGG_Locomotive, 0.0, 60.0, 150.0));
		
		this.Write_Green_Goals(Green_Goals);
		
	}
	
	public void Create_Quality_Desires()
	{
		ArrayList<TQuality_Standing_Desire> Quality_Goals = new ArrayList<TQuality_Standing_Desire>();
		
		//Panorama\_is\_Great
//		TQuality_Goal Quality_Goal1 = new TQuality_Goal("qg1", "p6", TType_Quality_Goal.TGQ_Panorama,
		TQuality_Standing_Desire Quality_Goal1 = new TQuality_Standing_Desire("Panorama_is_Great", "p6", TType_Quality_Desire.TGQ_Panorama,
				0.4, 0.0, 0.3);
		//Velocity\_is\_Moderate
		//TQuality_Goal Quality_Goal2 = new TQuality_Goal("qg2", "p7", TType_Quality_Goal.TGQ_Velocity,
		TQuality_Standing_Desire Quality_Goal2 = new TQuality_Standing_Desire("Driving_Safely", "p7", TType_Quality_Desire.TGQ_Velocity,
				0.11, 0.21, 0.31);
