...
import com.Catalina_Model.Catalina_V_0_3.TPlan;
import com.Catalina_Model.Catalina_V_0_3.TTriple_Object;


public class TPlan_Simulation extends TPlan
{
	public ArrayList<TCity> Destinations;
	  ...
	  */
	 public void Insert_Path_by_Routes( List<TCity> Destionations, List<Integer> Numbered_Route, 
	  ...
	  * @param path_Time				Path Time
	  */
	 public void Insert_Path_by_Stations( List<TRoute> Routes, List<Integer> Numbered_Destinations, 
			 EnumMap<TType_Quality_Desire, Double> Weights, Double path_Time)
	 {
		 List<TCity> Destinations = new ArrayList<TCity>();
	  ...
	  * @param Plan_Path
	  */
	 public void Copy_Plan(TPlan_Simulation Plan_Path)
	 {
