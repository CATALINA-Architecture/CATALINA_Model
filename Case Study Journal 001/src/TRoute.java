...
public class TRoute 
{
	...
	private TCity Departure;
	private TCity Destination;
	...
	private TMotor Locomotive;
	private TPanorama The_Panorama;
	private TSpeed Speed;
	 ...
	 */
	public TPanorama Get_Panorama_() {
	 ...
	 * @return	An integer value
	 */
	public int Gget_Route_used_by_agent() {
	 ...
	 * @param route_Number
	 */
	public TRoute(TCity departure, TCity destination, TColor color, int steps_Number, 
			TMotor locomotive, TPanorama panorama, TSpeed speed, int route_Number)
	{
	...
	public String Get_Route_Status()
	{
		return this.Route_Status;
	}
	
	public void Set_Route_Status(String Value)
	{
		this.Route_Status = Value;
	}
}