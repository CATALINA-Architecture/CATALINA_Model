...
//		Come_Back_to_City
	...
	public TAction_Execution_Result Execute_Initialize_Way(TAction Action, HashMap<String, TBelief> Beliefs_Cloned )
	{
...
//		result.Set_Object_Second( Data );
	...
	public TAction_Execution_Result Execute_Wait(TAction Action, HashMap<String, TBelief> Map_Beliefs )
	{
		TAction_Execution_Result result = new TAction_Execution_Result();
...
//		result.Set_Object_Second( Data );
	 ...
	 * @return
	 */
	public TAction_Execution_Result Execute_Ask_Danger_Type_on_the_road(TAction Action, HashMap<String, TBelief> Map_Beliefs )
	{
		TAction_Execution_Result result = new TAction_Execution_Result();
...
//		result.Set_Object_Second( Data );
	...
	public TAction_Execution_Result Execute_Reverse_Direction(TAction Action, HashMap<String, TBelief> Map_Beliefs )
	{
		TAction_Execution_Result result = new TAction_Execution_Result();
...
//								Ruotes_Coords.get(Integer_Start_Route);
	...
	public TAction_Execution_Result Execute_Movement_Go_TO_Route(TAction Action, HashMap<String, TBelief> Map_Beliefs )
	{
		TAction_Execution_Result result = new TAction_Execution_Result();
		/**
		 * 
...
//		result.Set_Object_Second( Data );
	...
	public TAction_Execution_Result Execute_Movement_GO_TO_Step(TAction Action, HashMap<String, TBelief> Map_Beliefs )
	{
		TAction_Execution_Result result = new TAction_Execution_Result();
		/**
		 * 
...
//		result.Set_Object_Second( Data );
	 ...
	 */
	private TAction_Execution_Result Rise_Come_Back_Desire( ArrayList<Integer> Positions,
...
//		"BL_Current_Time"		
	...
	public TAction_Execution_Result Execute_Change_Direction(TAction Action, HashMap<String, TBelief> Map_Beliefs )
	{
		TAction_Execution_Result result = new TAction_Execution_Result();
