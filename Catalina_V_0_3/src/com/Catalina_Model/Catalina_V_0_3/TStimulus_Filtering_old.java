...
/**
 * This class gets each stimulus generated by Information Extraction module.
 * For each stimulus it applies a filter to check if it falls in an inhibition region or not.
 * If yes, the stimulus saliency in compared to Attention threshold of the agent, 
 * otherwise its saliency is compared with the saliency threshold.
 * Then, the stimuli that passes the thresholds become "Survived Stimuli"
 * 
...
public class TStimulus_Filtering_old 
{
...
//	private HashMap< String, Double> Saliencies_for_Stimuli;
	...
	public TStimulus_Filtering_old(TExecutive_Memory_Maintenance_Function Owner)
	{
		this.Parent = Owner;
